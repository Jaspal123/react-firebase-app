...
class LoginManagementBase extends Component{
    ...
    fetchSignInMethods = () => {
        this.props.firebase.auth.fetchSignInMethodsForEmail(this.props.authUser.email)
...
class DefaultLoginToggle extends Component{
    ...
    render(){
        ...
        return isEnabled?(
            <button type="button" onClick={() => onUnlink(signInMethod.id)} disabled={onlyOneLeft}>Deactivate {signInMethod.id}</button>
        ): (
            <form onSubmit={this.onSubmit}>
                ...
                <button type="submit" disabled={isInvalid}>Link {signInMethod.id}</button>
            </form>
        )
    }
}
